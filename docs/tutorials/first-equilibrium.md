...
The third row identifies the system component for the amount columns. Where a phase or constituent/component does not apply, enter `""` so PyroApp treats the field as empty while the header cell remains populated. This keeps the three-row header contiguous and easy to select and manipulate.
