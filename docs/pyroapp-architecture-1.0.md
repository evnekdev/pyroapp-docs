...
PyroApp preserves the useful worksheet concepts while replacing the Excel boundary with Excel-DNA/C#, moving datafile parsing into Rust, and isolating ChemApp execution in worker processes.
